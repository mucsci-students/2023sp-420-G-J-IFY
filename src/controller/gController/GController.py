...
class GController():
    ...
    def connectSignals(self):
        ...
        dialog.warningBtns.accepted.connect(
            lambda: MakePuzzle.newPuzzle(puzzle, outty, window, '', '')
            )
        # newPuzzle uses provided params
        dialog.advBtns.accepted.connect(
        lambda: MakePuzzle.newPuzzle(puzzle, outty, window, baseWord, keyLett))
        ...
        window.loadDialog.btns.accepted.connect(lambda: StateStorage.loadGame(puzzle, window))
